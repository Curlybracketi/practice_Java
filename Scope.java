 // Scope.java
 // Scope class demontrates field and local variable scopes.
 ...
 public class Scope
 {
     ...
     // method main creates and initilaizes local variable x
     ...
     public static void main( String[] args )
     {
         ...
         useField(); // class scope's // class Scope's field x retains its value

         System.out.printf( "\nlocal x in main is %d\n", x );
     } // end main

      // create and initializes local variable x during each call
