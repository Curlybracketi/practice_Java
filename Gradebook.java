 ...
 public class Gradebook
         ...
         System.out.printf( "\n%s %d\n%s %d\n\n",
                 ...
                 "Highest grade im thr grade book is", getMaximum() );
         ...
         for ( int grade : studentGrades )
             {
                 // if grades less than lowGrade, assign it to lowGrade
                 if ( grade < lowGrade )
                     lowGrade =grade;
             } // end inner for
         } // end outer for
         ...
         {
             // assume first element of grades arrays is largest
